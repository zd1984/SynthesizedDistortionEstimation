...
#if ENABLE_VSDE
bool CViewInterpolation::Init(CParameterViewInterpolation &cParameter, HANDLE tLeft, HANDLE tRight, HANDLE dLeft, HANDLE dRight)
#else
...
#if ENABLE_VSDE
    m_pViewSynthesis1D->setSharedMemoryHandle(tLeft, tRight, dLeft, dRight);
#endif
